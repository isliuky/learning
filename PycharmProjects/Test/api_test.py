...
default_value_col = {'LastUpdtTime': datetime.datetime.now(tz=LOCAL_ZONE).strftime("%Y-%m-%d %H:%M:%S"),
                     'Feed': '',
                     'FeedType': '2'}
...
data = [
        {
            "name": "uv370 cta",
            "businessCategoryName": "引进新设备",
            "productName": "Ultravist370 1*100ml",
            "saleProcessName": "需求确定",
            "externalUserName": "雪中骏马",
            "externalUserId": "wmX8fADwAAbOO5-0sfvVCvz_Df8rSjLg",
            "unionId": "ooqw156eBR8mUxMm1PV_iC4TmVjA",
            "corpName": "中山市西区医院",
            "corpId": 24282,
            "corpHisCode": "519625",
            "createTime": "2023-07-21 16:18:49",
            "wxworkUserId": "GMTQP",
            "masterUserName": "Chunyu Yue",
            "flowUserId": "GMTQP",
            "flowUserName": "Chunyu Yue",
            "preSaleAmount": 'null',
            "preSignDate": 'null',
            "customField": [
                {
        ...
        },
        {
            ...
            "saleProcessName": "需求确定",
            "externalUserName": "望乡",
            "externalUserId": "wmX8fADwAAu_ZItkzxbP1MKHaYW2bOtg",
            "unionId": "ooqw156hPM2n91qYJ6fE4zH2o6Eg",
            "corpName": "成安县中医院",
            "corpId": 24072,
            "corpHisCode": "537554",
            "createTime": "2023-07-20 13:24:18",
            "wxworkUserId": "GOBGB",
            "masterUserName": "Julia Zhu",
            "flowUserId": "GOBGB",
            "flowUserName": "Julia Zhu",
            "preSaleAmount": 'null',
            "preSignDate": 'null',
            "customField": [
                {
...
weFeng = {
    ...
    'testnichelist': {'dynamic_mapping': {'original_col': ['customField', 'fieldCode'],
                                        'original_values': ['CustomField_26948'],
                                        'new_add_col': {'is_submit_application_form':''}},
                                'static_mapping': [],
                                'api_table_mapping': {
                                    'name':'name',
...
# 设备信息
'hospital_equipment': {'dynamic_mapping': {'original_col': ['bizField', 'fieldCode'],
                                        'original_values': ['CustomField_894', 'CustomField_746',
                                                            'CustomField_679', 'CustomField_678', 'CustomField_680',
                                                            'CustomField_677'],
                                        'new_add_col': {'devices_numType': 'devices_num',
                                                        'host_brand_1Type': 'host_brand_1',
                                                        'high_injection_brandType': 'high_injection_brand',
                                                        'host_brand_2Type': 'host_brand_2',
                                                        'high_injection_modelType': 'high_injection_model',
                                                        'host_modelType': 'host_model'}
                                        },
                'static_mapping': [],
                'api_table_mapping': {
                    'id': 'id',
...
permissionRole = {'CWID': ['GMTLS', 'GMTUB', 'GMTQP', 'GNDAT', 'GNIQD', 'GNIPU', 'GNKUY', 'GOBGB'],
                  'Name': ['朱昱烨', '颜晓懂', '岳春雨', '刘静妮', '陈功', '陆鑫蔚', '彭可鑫', '朱晓琳'],
                  }
...
def dynamic_mapping_handler(data_dict, original_col, original_values, new_add_col_dict):
    ...
    new_col_values = {}
    print(f' fields_df:{fields_df}')
    print("==============================")
    print(f' original_values_df:{original_values_df}')
    print("==============================")
    if fields:
...
def wefeng_data_source_handler(api_name, url, data, bucket):
    ...
    if data:
        ...
        for data_dict in data:
            ...
            print(f"dynamic_mapping{dynamic_mapping}")
            if dynamic_mapping:
    ...
    return res_list
url = "https://bayer.wefeng360.com/api/v1/niche/list?sign=ad87e8df4936fae8e2ec122f3418966005524b7857f5dcdd68dcb85af0c4ad40&timestamp=1694500462"
bucket = "S3"
pages_data_list = wefeng_data_source_handler("testnichelist", url, data, bucket)
